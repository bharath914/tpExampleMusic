...
public class PlayerService extends Service {
    ...
    public void onCreate() {
        ...
        notificationManager=new PlayerNotificationManager.Builder(this,notificationId,channelId)
                ...
                .setPlayActionIconResourceId(R.drawable.baseline_pause_24)
                .setPauseActionIconResourceId(R.drawable.baseline_play_arrow_24)
...
PlayerNotificationManager.MediaDescriptionAdapter descriptionAdapter=new PlayerNotificationManager.MediaDescriptionAdapter() {
    ...
    public Bitmap getCurrentLargeIcon(Player player, PlayerNotificationManager.BitmapCallback callback) {
        ...
        if(bitmapDrawable==null){
            bitmapDrawable=(BitmapDrawable) ContextCompat.getDrawable(getApplicationContext(),R.drawable.starboy);
        }
